...
Welcome to the technical documentation for the WordPress Auth Service & `wp-app-bridge` plugin repository.
...
- **[`architecture.md`](file:///e:/ab-code-projects/projects/Wordpress/plugins/auth-service/docs/architecture.md)** — Comprehensive architecture overview, component boundaries (`wp_auth_lib`, `wp_auth_service`, `wp-app-bridge`, `static`), REST API specifications, exception hierarchy, and auth sequence data flows.
